...
testers = {
    ...
    'enchilada': ['anirudhgupta109', 'ronell1292k', 'Giuseppe_Longobardo', 'Pavan_Paps'],
    'fajita': ['ironhydee', 'gautamhans1', 'edi194'],
    'guacamole': ['anirudhgupta109', 'RandomPooka', 'nezorflame'],
    'hotdogb': ['anirudhgupta109', 'McConvict', 'georgemath24', 'gotenksIN'],
    ...
    'raphael': ['Ayushd70', 'federicog86', 'GodsAmongU', 'panicker666', 'ZERJ23', 'Pavan_Paps'],
    'sargo': ['Skittles9823'],
    'taimen': ['Eamo5'],
